...
def align(input_tokens, valid_tokens, output_path):
    ...
    if "mwmf" in aligner.matching_methods:
        with open(output_path + "mwmf_align.src-trg", "w+") as f:
            f.writelines(list(map(lambda x: x + "\n", itermax)))

    if "inter" in aligner.matching_methods:
        with open(output_path + "inter_align.src-trg", "w+") as f:
            f.writelines(list(map(lambda x: x + "\n", itermax)))

    if "itermax" in aligner.matching_methods:
        with open(output_path + "itermax_align.src-trg", "w+") as f:
            f.writelines(list(map(lambda x: x + "\n", itermax)))
